...
func TestVCShortcuts_RegistersMeetingAgentCommands(t *testing.T) {
	...
	want := []string{"+search", "+notes", "+recording", "+detail", "+meeting-join", "+meeting-invite", "+meeting-end", "+meeting-leave", "+meeting-list-active", "+meeting-events", "+meeting-message-send", "+meeting-screenshot", "+meeting-countdown", "+meeting-participant-kickout", "+meeting-participant-mute", "+meeting-participant-unmute"}
