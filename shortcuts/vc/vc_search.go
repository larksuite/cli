...
var VCSearch = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "organizer-ids", Desc: "organizer open_id list, comma-separated (OR: matches meetings organized by any listed user)"},
		{Name: "participant-ids", Desc: "participant open_id list, comma-separated (OR: matches meetings any listed user joined; not AND)"},
		{Name: "room-ids", Desc: "room_id list, comma-separated (OR: matches meetings held in any listed room)"},
