...
func registerDeleteApprovalValidationStub(reg *httpmock.Registry) {
	reg.Register(&httpmock.Stub{
		Method: "POST",
		URL:    deleteApprovalValidatePath,
...
func TestBaseFieldExecuteCRUD(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseFieldDelete, []string{"+field-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--field-id", "fld_x", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseTableExecuteReadAndDelete(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseTableDelete, []string{"+table-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseRecordExecuteReadCreateDelete(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		reg.Register(batchStub)
		if err := runShortcut(t, BaseRecordDelete, []string{"+record-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--record-id", "rec_1", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
	...
	t.Run("delete returns batch_delete error when unavailable", func(t *testing.T) {
		...
		reg.Register(batchStub)
		err := runShortcut(t, BaseRecordDelete, []string{"+record-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--record-id", "rec_1", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout)
		if err == nil {
	...
	t.Run("delete batch with repeated record-id flags", func(t *testing.T) {
		...
		reg.Register(batchStub)
		if err := runShortcut(t, BaseRecordDelete, []string{"+record-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--record-id", "rec_2", "--record-id", "rec_1", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
	...
	t.Run("delete batch with json selector", func(t *testing.T) {
		...
		reg.Register(batchStub)
		if err := runShortcut(t, BaseRecordDelete, []string{"+record-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--json", `{"record_id_list":["rec_3"]}`, "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
...
func TestBaseViewExecuteReadCreateDeleteAndFilter(t *testing.T) {
	...
	t.Run("delete", func(t *testing.T) {
		...
		if err := runShortcut(t, BaseViewDelete, []string{"+view-delete", "--base-token", "app_x", "--table-id", "tbl_x", "--view-id", "vew_1", "--auth-code", "larkauth_v1_demo", "--yes"}, factory, stdout); err != nil {
			t.Fatalf("err=%v", err)
		}
