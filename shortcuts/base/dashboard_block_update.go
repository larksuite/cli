...
var BaseDashboardBlockUpdate = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "switch-row-column", Type: "bool", Desc: "explicitly enable or disable row/column switching; supported block types: column, line, bar, area, scatter; use --switch-row-column=true or --switch-row-column=false"},
	...
	Tips: []string{
		...
		`lark-cli base +dashboard-block-update --base-token <base_token> --dashboard-id <dashboard_id> --block-id <block_id> --switch-row-column=true`,
		`lark-cli base +dashboard-block-update --base-token <base_token> --dashboard-id <dashboard_id> --block-id <block_id> --switch-row-column=false`,
		...
		"Row/column switching is supported only for column, line, bar, area, and scatter blocks; unsupported block types return feature_not_available.",
