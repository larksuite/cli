...
var BaseFormSubmit = common.Shortcut{
	...
	Tips: []string{
		...
		`Cell values in "fields" follow the Record section of the lark-base skill; "attachments" maps field names to local file path arrays — the CLI uploads them in parallel and merges them into the submission.`,
		baseHighRiskYesTip,
	},
