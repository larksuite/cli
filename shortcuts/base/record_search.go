...
var BaseRecordSearch = common.Shortcut{
	...
	Tips: []string{
		...
		`Example for analysis: lark-cli base +record-search --base-token <base_token> --table-id <table_id> --keyword Alice --search-field Name --field-id Name --field-id Status --format ndjson --output ./records.ndjson --minimal-stdout`,
