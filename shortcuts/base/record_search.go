...
var BaseRecordSearch = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "limit", Aliases: []string{"page-size"}, Type: "int", Desc: "maximum records to return; range 1-200, or 1-10000 for ndjson; omitted limit uses 10 inline or 10000 for ndjson"},
	...
	Tips: []string{
		`Happy path fields: keyword (string), search_fields (1-20 field names/ids), select_fields (optional projection, <=50), view_id (optional), offset (default 0), limit (default 10 inline or 10000 for ndjson; inline range 1-200, ndjson range 1-10000).`,
		"JSON constraints: keyword length >=1; search_fields length 1-20; select_fields length <=50; offset >=0 defaults to 0; omitted limit uses 10 inline or 10000 for ndjson.",
