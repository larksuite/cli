...
var BaseRoleUpdate = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "json", Desc: "delta role config JSON; read lark-base-advanced-permission-and-role.md and lark-base-role-config.md before changing permissions", Required: true},
	},
	Tips: []string{
		baseHighRiskYesTip,
