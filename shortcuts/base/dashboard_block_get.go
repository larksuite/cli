...
var BaseDashboardBlockGet = common.Shortcut{
	...
	Tips: []string{
		...
		"Verify chart configuration from data_config fields such as table_name, group_by, filter, series, and count_all; a matching block name or computed value is not enough.",
