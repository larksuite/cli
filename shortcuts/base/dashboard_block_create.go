...
var BaseDashboardBlockCreate = common.Shortcut{
	...
	Tips: []string{
		...
		"Button (按钮) is an interactive component, not a chart; its data_config carries action and display configuration. Read domain/dashboard/button.md for the button component boundary before creating.",
