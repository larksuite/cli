...
var recordCellValueHappyPathTips = []string{
	...
	"Read the Record section with `lark-cli skills read lark-base` for CellValue shapes and special field types; do not invent values for fields not covered by the happy path.",
}
