...
var flagDefs = map[string]commandDef{
	...
	"+chart-config-update": {
		...
		Flags: []flagDef{
			...
			{Name: "color-palette", Kind: "own", Type: "string", Required: "optional", Desc: "Preset chart-level color palette; mutually exclusive with --colors. Multi-category: brand (default) / rainbow (many series) / contrast (high contrast); use diverging for positive-negative data, muted for soft light tints, and mono-<color> for a single series or ordered magnitude (mono-cyan is cyan, mono-gray is neutral grey)", Enum: []string{"brand", "rainbow", "contrast", "diverging", "muted", "mono-blue", "mono-cyan", "mono-green", "mono-yellow", "mono-orange", "mono-red", "mono-gray"}},
	...
	"+chart-create-basic": {
		...
		Flags: []flagDef{
			...
			{Name: "series-data-labels", Kind: "own", Type: "string", Required: "optional", Desc: "Combo charts only; comma-separated data-label settings aligned with explicit --dim2-indexes, one value per selected series; none disables labels for that series; mutually exclusive with --data-labels, while --data-label-position applies to the remaining series"},
