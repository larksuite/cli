...
func wbNodeCreateValidate(_ context.Context, runtime *common.RuntimeContext) error {
	...
	_, err := parseWbNodeBatchPayload([]byte(runtime.Str("source")), false)
	return err
}

func wbNodeCreateDryRun(_ context.Context, runtime *common.RuntimeContext) *common.DryRunAPI {
	payload, err := parseWbNodeBatchPayload([]byte(runtime.Str("source")), false)
	if err != nil {
	...
	dry := common.NewDryRunAPI().
		...
		Body(wbNodeCreateReq{Nodes: payload.Nodes}).
...
func wbNodeCreateExecute(_ context.Context, runtime *common.RuntimeContext) error {
	...
	data, err := runtime.CallAPITyped(
		...
		wbNodeCreateReq{Nodes: payload.Nodes},
	)
	if err != nil {
		return err
	}

	nodeIDs, err := wbNodeCreateIDs(data)
	if err != nil {
		return err
	}
...
func wbNodeCreateIDs(data map[string]interface{}) ([]string, error) {
