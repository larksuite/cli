...
var AppsAutomationUpdate = common.Shortcut{
	...
	Tips: []string{
		"Example: lark-cli apps +automation-update --app-id <id> --name t1 --trigger-type cron --cron '0 10 * * *' --yes   # only after the user has confirmed",
		"Example: lark-cli apps +automation-update --app-id <id> --name rc1 --trigger-type record-change --table <tbl> --event UPDATE --fields '[\"fld1\"]' --yes   # only after the user has confirmed",
		"Example: lark-cli apps +automation-update --app-id <id> --name apv --trigger-type feishu-approval --event-type approval_instance --instance-status APPROVED --yes   # only after the user has confirmed",
		"Example: lark-cli apps +automation-update --app-id <id> --name wh1 --reset-url --app-env preview --yes   # only after the user has confirmed",
		"Example: lark-cli apps +automation-update --app-id <id> --name wh1 --enable-token --yes   # only after the user has confirmed",
		"Example: lark-cli apps +automation-update --app-id <id> --name wh1 --white-ip-list '[\"1.1.1.1\"]' --yes   # only after the user has confirmed",
	},
