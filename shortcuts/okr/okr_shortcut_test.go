...
func okrTestConfig(t *testing.T) *core.CliConfig {
	t.Helper()
...
func okrShortcutTestFactory(t *testing.T) (*cmdutil.Factory, *bytes.Buffer, *bytes.Buffer, *httpmock.Registry) {
	t.Helper()
	return cmdutil.TestFactory(t, okrTestConfig(t))
}

func runMountedOkrShortcut(t *testing.T, shortcut common.Shortcut, args []string, f *cmdutil.Factory, stdout *bytes.Buffer) error {
	t.Helper()
	parent := &cobra.Command{Use: "test"}
