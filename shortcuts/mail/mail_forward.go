...
var MailForward = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Recipient list. May be repeated; each occurrence may contain comma-separated recipients. Quote each value. RFC display-name format, including quoted commas, is supported."},
		...
		{Name: "cc", Type: "string_array", Desc: "CC recipient list. May be repeated; each occurrence may contain comma-separated recipients. Quote each value. RFC display-name format, including quoted commas, is supported."},
		{Name: "bcc", Type: "string_array", Desc: "BCC recipient list. May be repeated; each occurrence may contain comma-separated recipients. Quote each value. RFC display-name format, including quoted commas, is supported."},
		{Name: "plain-text", Type: "bool", Desc: "Force plain-text mode, ignoring all HTML auto-detection. Cannot be used with --inline."},
		{Name: "attach", Type: "string_array", Desc: "Attachment file paths appended after original attachments (relative paths only). May be repeated; each occurrence may contain comma-separated paths. Quote each value; input order is preserved."},
