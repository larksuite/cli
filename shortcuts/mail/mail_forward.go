...
var MailForward = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Recipient email address. Repeat --to or pass a comma-separated address list in one occurrence; quote each value. Display-name format is supported."},
		...
		{Name: "cc", Type: "string_array", Desc: "CC email address. Repeat --cc or pass a comma-separated address list in one occurrence; quote each value. Display-name format is supported."},
		{Name: "bcc", Type: "string_array", Desc: "BCC email address. Repeat --bcc or pass a comma-separated address list in one occurrence; quote each value. Display-name format is supported."},
		{Name: "plain-text", Type: "bool", Desc: "Force plain-text mode, ignoring all HTML auto-detection. Cannot be used with --inline."},
		{Name: "attach", Type: "string_array", Desc: "Attachment file path, appended after original attachments (relative path only). Repeat --attach or pass a comma-separated path list in one occurrence; quote each value. Order is preserved."},
