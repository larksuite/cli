...
var MailReply = common.Shortcut{
	...
	DryRun: func(ctx context.Context, runtime *common.RuntimeContext) *common.DryRunAPI {
		...
		desc := "Reply: fetch original message → resolve sender from --mailbox, original recipients, or default send_as → save as draft"
		if confirmSend {
			desc = "Reply (--confirm-send): fetch original message → resolve sender from --mailbox, original recipients, or default send_as → create draft → send draft"
		}
