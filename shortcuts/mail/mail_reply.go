...
var MailReply = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Additional To address. Repeat --to or pass a comma-separated address list in one occurrence; quote each value; appended to the original sender's address."},
