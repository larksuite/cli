...
var MailReply = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Additional To recipients. May be repeated; each occurrence may contain an RFC recipient list. Quote each value; appended to the original sender's address."},
