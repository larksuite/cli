...
var MailReplyAll = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "to", Type: "string_array", Desc: "Additional To address. Repeat --to or pass a comma-separated address list in one occurrence; quote each value; appended to original recipients."},
		{Name: "cc", Type: "string_array", Desc: "Additional CC email address. Repeat --cc or pass a comma-separated address list in one occurrence; quote each value."},
		{Name: "bcc", Type: "string_array", Desc: "BCC email address. Repeat --bcc or pass a comma-separated address list in one occurrence; quote each value."},
		{Name: "remove", Type: "string_array", Desc: "Address to exclude from the outgoing reply. Repeat --remove or pass a comma-separated address list in one occurrence; quote each value. Order is preserved."},
		{Name: "plain-text", Type: "bool", Desc: "Force plain-text mode, ignoring all HTML auto-detection. Cannot be used with --inline."},
		{Name: "attach", Type: "string_array", Desc: "Attachment file path, relative path only. Repeat --attach or pass a comma-separated path list in one occurrence; quote each value. Order is preserved."},
