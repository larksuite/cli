...
var ImMessagesSend = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "content", Desc: "(one of --content/--text/--markdown/--image/--file/--video/--audio required) message content JSON (inline, @file, or - for stdin)", Input: []string{common.File, common.Stdin}},
		{Name: "text", Desc: "plain text message (auto-wrapped as JSON; inline, @file, or - for stdin)", Input: []string{common.File, common.Stdin}},
		{Name: "markdown", Desc: "markdown text (auto-wrapped as post format with style optimization; image URLs auto-resolved; inline, @file, or - for stdin)", Input: []string{common.File, common.Stdin}},
