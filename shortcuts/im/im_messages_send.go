...
var ImMessagesSend = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "content", Desc: "(one of --content/--text/--markdown/--image/--file/--video/--audio required) message content JSON; pass '-' for stdin or '@path' for a file", Input: []string{common.File, common.Stdin}},
		{Name: "text", Desc: "plain text message (auto-wrapped as JSON); pass '-' for stdin or '@path' for a file", Input: []string{common.File, common.Stdin}},
		{Name: "markdown", Desc: "markdown text (auto-wrapped as post format with style optimization; image URLs auto-resolved); pass '-' for stdin or '@path' for a file", Input: []string{common.File, common.Stdin}},
