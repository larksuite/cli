...
const privateKeyOpenFlags = os.O_RDONLY
...
func unlockSecretLockDirectory(_ string) (string, error) {
	...
	return validate.SafeEnvDirPath(filepath.Join(directory, keychain.LarkCliService, "keysigner", "keyless", keysigner.SoftwareSignerName), "software unlock lock directory")
}
