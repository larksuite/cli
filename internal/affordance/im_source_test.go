...
var imAffordanceExamples = []imAffordanceExample{
	...
	{method: "+chat-messages-list", command: "lark-cli im +chat-messages-list --chat-id oc_xxx --format concise", source: "lark-im/references/lark-im-chat-messages-list.md"},
	...
	{method: "+threads-messages-list", command: "lark-cli im +threads-messages-list --thread omt_xxx --format concise", source: "lark-im/references/lark-im-threads-messages-list.md"},
