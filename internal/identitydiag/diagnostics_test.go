...
func TestDiagnose_NoUserReportsBotReadyAndUserMissing(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "test-app", AppSecret: "secret", Brand: brand.Feishu}
...
func TestDiagnose_BotIdentityNotConfigured(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "test-app", Brand: brand.Feishu}
	f, _, _, _ := cmdutil.TestFactory(t, cfg)
...
func TestDiagnose_UserIdentityMissingAppConfig(t *testing.T) {
	cfg := &configpkg.CliConfig{Brand: brand.Feishu}
	f, _, _, _ := cmdutil.TestFactory(t, cfg)
...
func externalFactory(prov *fakeExtProvider, cfg *configpkg.CliConfig) *cmdutil.Factory {
...
func TestDiagnose_External_UserReady(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Feishu, SupportedIdentities: uint8(extcred.SupportsAll), UserOpenId: "ou_x", UserName: "Alice"}
...
func TestDiagnose_External_UserNotSignedIn(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Feishu, SupportedIdentities: uint8(extcred.SupportsAll)}
	f := externalFactory(&fakeExtProvider{name: "corp-sso", account: &extcred.Account{AppID: "cli_x"}}, cfg)
...
func TestDiagnose_External_BotOnly(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Feishu, SupportedIdentities: uint8(extcred.SupportsBot), UserOpenId: "ou_x"}
	f := externalFactory(&fakeExtProvider{name: "corp-sso", account: &extcred.Account{AppID: "cli_x"}}, cfg)
...
func TestDiagnose_External_UserOnly(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Lark, SupportedIdentities: uint8(extcred.SupportsUser), UserOpenId: "ou_x", UserName: "Bob"}
	f := externalFactory(&fakeExtProvider{name: "corp-sso", account: &extcred.Account{AppID: "cli_x"}}, cfg)
...
func TestDiagnose_External_VerifyUserResolvesToken(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Feishu, SupportedIdentities: uint8(extcred.SupportsUser), UserOpenId: "ou_x", UserName: "Alice"}
...
func TestDiagnose_External_VerifyUserTokenUnavailable(t *testing.T) {
	cfg := &configpkg.CliConfig{AppID: "cli_x", Brand: brand.Feishu, SupportedIdentities: uint8(extcred.SupportsUser), UserOpenId: "ou_x"}
	f := externalFactory(&fakeExtProvider{name: "corp-sso", account: &extcred.Account{AppID: "cli_x"}}, cfg)
