...
func (m *MultiAppConfig) RequireAppConfig(profile string, source brand.ProfileSource) (*AppConfig, error) {
...
func (m *MultiAppConfig) ProfileNotFoundError(profile string, source brand.ProfileSource) error {
	...
	if source == brand.ProfileFromEnvironment {
