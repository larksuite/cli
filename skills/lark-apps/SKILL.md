...
| 获取妙搭应用 MCP 连接配置、准备运行态 MCP 凭证（可能创建凭证，默认脱敏） | `+mcp-get`、`+mcp-key-create` | [`lark-apps-mcp.md`](references/lark-apps-mcp.md) |
