...
而当需要绘制架构图，组织架构图，泳道图，对比图，鱼骨图，柱状图，折线图，树状图，漏斗图，金字塔图，循环/飞轮图，里程碑或其他较为复杂的图表时，推荐参考 [lark-whiteboard-draw](../lark-whiteboard-draw/SKILL.md) 使用 whiteboard-cli 工具创作。
