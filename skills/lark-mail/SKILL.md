...
<!-- AUTO-GENERATED-START: registry API resources and permissions -->
## API Resources
...
| `user_mailbox.messages.batch_get` | `mail:user_mailbox.message:readonly` AND `mail:user_mailbox.message.subject:read` AND `mail:user_mailbox.message.address:read` AND `mail:user_mailbox.message.body:read` |
...
| `user_mailbox.messages.get` | `mail:user_mailbox.message:readonly` AND `mail:user_mailbox.message.subject:read` AND `mail:user_mailbox.message.address:read` AND `mail:user_mailbox.message.body:read` |
