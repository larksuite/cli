...
| `user_mailbox.allow_sender.batch_create` | `mail:user_mailbox` |
| `user_mailbox.allow_sender.batch_remove` | `mail:user_mailbox` |
| `user_mailbox.allow_sender.list` | `mail:user_mailbox:readonly` |
| `user_mailbox.blocked_sender.batch_create` | `mail:user_mailbox` |
| `user_mailbox.blocked_sender.batch_remove` | `mail:user_mailbox` |
| `user_mailbox.blocked_sender.list` | `mail:user_mailbox:readonly` |
