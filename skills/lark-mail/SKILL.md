...
| [`+watch`](references/lark-mail-watch.md) | Watch incoming mail through the unified `event consume mail.message_received_v1` path. Prefer direct `event consume` for AI subprocesses; use `+watch` for legacy flags. |
