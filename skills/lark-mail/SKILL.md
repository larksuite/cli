...
### user_mailbox.allow_senders
  ...
  - Prefer `mail user-allow-block` for day-to-day allow/block management because it wraps both allow and blocked sender resources behind one command shape.
...
| `user-allow-block list/search/get` | `mail:user_mailbox.message:readonly` |
| `user-allow-block add/delete` | `mail:user_mailbox.message:modify` |
