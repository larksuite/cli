...
`../../lark-whiteboard/GUIDE.md`](../../lark-whiteboard/GUIDE.md) 编辑。
...
- 图表目标、推荐画板类型、受众
- 与图表直接相关的源段落或数据
- 要求读取 [`../../lark-whiteboard/GUIDE.md`](../../lark-whiteboard/GUIDE.md)，按其完整流程写入该 board_token
...
- 画板查询/创作/修改/渲染写入：[`../../lark-whiteboard/GUIDE.md`](../../lark-whiteboard/GUIDE.md)
