...
- 上传 / 下载文件到知识库节点下 → [`lark-drive`](../lark-drive/GUIDE.md)（`drive +upload --wiki-token`）
- 编辑文档正文内容 → [`lark-doc`](../lark-doc/GUIDE.md)
- 表格 / 多维表格数据操作 → [`lark-sheets`](../lark-sheets/GUIDE.md) / [`lark-base`](../lark-base/GUIDE.md)
- 按名称搜索文档 / Wiki / 表格文件、评论与权限管理 → [`lark-drive`](../lark-drive/GUIDE.md)
