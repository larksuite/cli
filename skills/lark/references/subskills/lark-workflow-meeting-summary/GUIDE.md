...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`../lark-shared/GUIDE.md`](../lark-shared/GUIDE.md)，其中包含认证、权限处理**。然后阅读 [`../lark-vc/GUIDE.md`](../lark-vc/GUIDE.md)，了解会议纪要相关操作。
...
阅读 [`../lark-doc/GUIDE.md`](../lark-doc/GUIDE.md) 学习云文档技能。
...
- [lark-vc](../lark-vc/GUIDE.md) — `+search`、`+notes` 详细用法
- [lark-doc](../lark-doc/GUIDE.md) — `+fetch`、`+create`、`+update` 详细用法