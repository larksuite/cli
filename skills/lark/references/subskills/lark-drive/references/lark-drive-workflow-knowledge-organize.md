...
Before running this workflow, MUST read [`../../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) for identity, authentication, permission handling, and write-operation confirmation rules.

Load other skills / references progressively:

- Wiki / personal library target: [`../../lark-wiki/GUIDE.md`](../../lark-wiki/GUIDE.md)
- Content read required: [`../../lark-doc/GUIDE.md`](../../lark-doc/GUIDE.md) and [`../../lark-doc/references/lark-doc-fetch.md`](../../lark-doc/references/lark-doc-fetch.md)
- Sheet down-drill required: [`../../lark-sheets/GUIDE.md`](../../lark-sheets/GUIDE.md)
- Base down-drill required: [`../../lark-base/GUIDE.md`](../../lark-base/GUIDE.md)
...
- [lark-shared](../../lark-shared/GUIDE.md)
- [lark-drive](../GUIDE.md)
