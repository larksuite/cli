...
| [`+whiteboard-update`](references/lark-doc-whiteboard.md#docs-whiteboard-update-说明) | Alias of `whiteboard +update`. Update an existing whiteboard with Mermaid, PlantUML or DSL (stdin). Prefer `whiteboard +update`; refer to lark-whiteboard skill for details. |
