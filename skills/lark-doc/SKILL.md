...
| [`+whiteboard-update`](references/lark-doc-whiteboard.md) | Alias of `whiteboard +update`. Update an existing whiteboard with Mermaid, PlantUML or DSL (stdin). Prefer `whiteboard +update`; refer to lark-whiteboard skill for details. |
