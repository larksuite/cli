...
2. 按照 [`lark-doc-whiteboard.md`](lark-doc-whiteboard.md) 的委派规范，为每个 board_token 启动独立 subAgent
3. subAgent 读取 `skills/lark-whiteboard/SKILL.md`，跳至"渲染 & 写入画板"章节，生成并写入实际内容
