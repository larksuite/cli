# vc +meeting-recording-start / +meeting-recording-stop
...
| 命令 | 方法与路径 | 请求体 |
|---|---|---|
| `vc +meeting-recording-start` | `PATCH /open-apis/vc/v1/meetings/:meeting_id/recording/start` | 无 |
| `vc +meeting-recording-stop` | `PATCH /open-apis/vc/v1/meetings/:meeting_id/recording/stop` | 无 |
