...
| [`+chat-messages-list`](references/lark-im-chat-messages-list.md) | List messages in a chat or P2P conversation; user/bot; resolves P2P chat_id, expands thread replies, supports concise conversation output and auto-pagination |
...
| [`+threads-messages-list`](references/lark-im-threads-messages-list.md) | List messages in a thread; user/bot; accepts om_/omt_ input, supports concise conversation output and auto-pagination |
