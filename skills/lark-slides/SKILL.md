...
| [`+replace-slide`](references/lark-slides-replace-slide.md) | Replace elements on a slide via block_replace / block_insert parts (auto-injects id on block_replace replacement roots) |
