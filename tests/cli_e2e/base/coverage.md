...
- TestBaseTemplateCenterDryRun: proves `+template-categories`, `+template-list`, and `+template-search` request shapes, including cursor pagination and the `--page-size` alias.
