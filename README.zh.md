...
为帮助防范访问令牌被盗用，我们在向飞书/Lark 官方 HTTPS 精确域名发起 OpenAPI 请求时，CLI 会发送一组最小化的风控保护信号。该保护默认开启，发送的风控保护信号包括：

- 操作系统类别：macOS、Windows 或 Linux
- macOS 和 Windows 的硬件产品型号：例如 Mac17.9
- CPU/进程架构：例如 x86_64、arm64
